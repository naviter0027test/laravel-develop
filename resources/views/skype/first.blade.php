<html>
    <head>
        <title>skype first test</title>
        <meta charset="utf-8" />
    </head>
    <body>
        <h1>Skype Test</h1>
        <a href="skype:live:km26v4x2z?chat"><img width="100" src="https://upload.wikimedia.org/wikipedia/commons/0/05/Skype_t.png" />Chat To Lanker</a>
        <br />
